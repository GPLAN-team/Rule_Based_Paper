...
#                 temp = K4()
#                 temp.nodes = cycle
#                 sep_tri,int_node = find_sep_tri(cycle,matrix)
...
# def find_sep_tri(cycle,degrees):
...
#     int_node = 0
#     for vertex in cycle:
#         degrees = contraction.degrees(grapmatrixh)
#         if(degrees[vertex] == 3):
#             int_node = vertex
#             break
#     for vertex in cycle:
...
# def get_nbr_nodes(sep_triangles,matrix,k4,edge):
...
# def removek4(sep_triangles,matrix,k4,edge,irreg_nodes1,irreg_nodes2,mergednodes):
#     """Removes given k4 from the graph.
...
#         get_nbr_nodes(sep_triangles,matrix,k4,edge)
#         k4.identified = 1
