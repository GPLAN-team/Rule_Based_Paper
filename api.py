...
<<<<<<< HEAD
        ...
        for cnt in range(len(graph.mergednodes)):
            output_fp.append({"id": graph.mergednodes[cnt]
                                ,"label": input_data['nodes'][graph.irreg_nodes1[cnt]]["label"]
                                ,"color": input_data['nodes'][graph.irreg_nodes1[cnt]]["color"]
...
<<<<<<< HEAD
            ...
            for cnt in range(len(graph.mergednodes[idx])):
                output_fp.append({"id": graph.mergednodes[idx][cnt]
